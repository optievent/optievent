        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Ajouter un participant</h4>
                    ...
                    <form class="forms-sample">
                      ...
                      <div class="row">
                        <div class="form-group col-md-6">
                            <label for="exampleSelectGender">Entreprise (Optionnel)</label>
                          ...
                          <div class="form-group col-md-6">
                            <label for="exampleSelectGender">Fonction (Optionnel)</label>
                            <input type="link" class="form-control" id="website" placeholder="Site Web">
                          </div>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Mot de passe : (<span class="red">*</span>)</label>
                            <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Password">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputConfirmPassword1">Confirmer le mot de passe : (<span class="red">*</span>)</label>
