          ...
          <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title"> Liste des entreprises inscrites à {{Event_Name}}</h4>
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            <tr>
                                ...
                                <td><label class="badge badge-dark fixed-badge "> 5 </label></td>
                                <td><label class="badge badge-warning fixed-badge"> 5 </label></td>

                                <td class="text-center"> 
                                    <button type="button" class="btn btn-dark"><i class="bi bi-plus-circle-fill"></i></button>
